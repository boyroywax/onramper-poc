...
exports.simulateSingleFetchFailure = exports.setFetchReturn = void 0;
...
fetchMock.mockImplementation(jest.fn().mockImplementation((url) => {
    ...
    if (indexFailure !== -1) {
        ...
        throw new FetchError_1.default(res);
    }
...
function simulateSingleFetchFailure(url = null, response) {
    const parsedResponse = JSON.parse(response !== null && response !== void 0 ? response : "{}");
    if (url === null) {
        fetchMock.mockImplementationOnce(jest.fn().mockImplementation(() => {
            throw new FetchError_1.default(parsedResponse);
        }));
    }
    else {
        singleFailUrls.push({
...
exports.simulateSingleFetchFailure = simulateSingleFetchFailure;
